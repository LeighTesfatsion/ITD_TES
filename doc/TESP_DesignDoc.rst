...
TESP runs on Microsoft Windows. The reader needs to install AMES V3.2, GridLAB-D, and the Framework for Network Cosimulation (FNCS).
The folder "Matlab and Python Files" contains some examples for how to modify the GridlabD glm files to customize the number of houses and appliances, and to automatically generate yaml files to communicatate data via TCP/IP 5570 (done via FNCS).
...
Outcome of a simulation with water heaters and HVACs for 540 houses over 8 days is depicted in Figure 10:
